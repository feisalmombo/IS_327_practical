...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link href="../css/vendors/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    ...
    <header>
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active" style="background-image: url('../imgs/cable12.jpg')">
            ...
            <div class="carousel-item" style="background-image: url('../imgs/header4.jpg')">
              <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item" style="background-image: url('../imgs/design.png')">
              <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item" style="background-image: url('../imgs/image5.png')">
              <div class="carousel-caption d-none d-md-block">
                <h3>Web Securit</h3>
                <p></p>
              </div>
            ...
            <!-- Slide Four - Set the background image for this slide in the line below -->
            <div class="carousel-item" style="background-image: url('../imgs/header8.jpg')">
              <div class="carousel-caption d-none d-md-block">
                <h3>Web Designing</h3>
                <p></p>
              </div>
            ...
            <!-- Slide Four - Set the background image for this slide in the line below -->
            <div class="carousel-item" style="background-image: url('../imgs/all.png')">
              <div class="carousel-caption d-none d-md-block">
                <h3>Our Services</h3>
                <p></p>
              </div>
...
<section id="about" style="padding-top: 20px;">
  <div class="container">
    ...
    <!-- Team -->
  <section class="bg-light" id="team" style="padding-top: 50px;">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading">Our Amazing Team</h2>
          <h3 class="section-subheading text-muted">Success of Company as Been motivated and inspired by the team members who participate fully.</h3>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-4">
        ...
        <div class="col-sm-4">
          <div class="team-member">
            <img class="mx-auto rounded-circle" src="img/team/1.jpg" alt="">
            <h4>Nasra Abas</h4>
            <p class="text-muted">Software Engineering Manager</p>
            <ul class="list-inline social-buttons">
              <li class="list-inline-item">
                <a href="#">
                  <i class="fa fa-twitter"></i>
        ...
        <div class="col-sm-4">
          <div class="team-member">
            <img class="mx-auto rounded-circle" src="img/team/2.jpg" alt="">
            <h4>Hatibu Mungia</h4>
            <p class="text-muted">Networking Manager</p>
            <ul class="list-inline social-buttons">
              <li class="list-inline-item">
                <a href="#">
                  <i class="fa fa-twitter"></i>
  ...
  <div class="portfolio-modal modal fade" id="portfolioModal2" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="portfolio-modal modal fade" id="portfolioModal4" tabindex="-1" role="dialog" aria-hidden="true">
      ...
      <!-- Bootstrap core JavaScript -->
          ...
          <!-- Bootstrap core JavaScript -->
          <script src="../css/vendors/jquery/jquery.min.js"></script>
          <script src="../css/vendors/popper/popper.min.js"></script>
          <script src="../css/vendors/bootstrap/js/bootstrap.min.js"></script>
    </body>
</html>
